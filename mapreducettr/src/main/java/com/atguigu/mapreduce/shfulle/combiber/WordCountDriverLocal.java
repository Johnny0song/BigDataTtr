package com.atguigu.mapreduce.shfulle.combiber;
...
public class WordCountDriverLocal {
    public static void main(String[] args) throws IOException {
        ...
        FileInputFormat.addInputPath(job, new Path("mapreducettr/data/inputword"));
        FileOutputFormat.setOutputPath(job, new Path("mapreducettr/data/output1"));
