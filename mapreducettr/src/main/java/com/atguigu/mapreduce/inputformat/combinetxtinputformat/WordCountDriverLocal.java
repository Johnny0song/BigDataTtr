...
public class WordCountDriverLocal {
    public static void main(String[] args) throws IOException {
        ...
        FileInputFormat.addInputPath(job, new Path("mapreducettr/data/inputcombinetextinputformat"));
        FileOutputFormat.setOutputPath(job, new Path("mapreducettr/data/inputcombinetextinputformat/output"));
        try {
